...
function esPrimo(numero) {
  ...
  if (numero === 2){ return true; } // 2 es el primer numero primo
  for( i = 2; i < numero; i++ ) {   
    if( numero % i === 0){
      return false;  // si existe un nro meos a el mismo con el que sea divisible implica que no es primo
    }  
    
  }
  return true; // caso contrario a todo lo anterior
}
